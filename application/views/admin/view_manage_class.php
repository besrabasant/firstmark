<!-- BEGIN CONTENT-->
            ...
            ?>
              ...
              <!-- BEGIN ADD CLASS FORM -->
							<div class="col-md-4">
								<?php echo form_open('school/manage_class',array('class' => 'form')); ?>
									<div class="card">
              ...
              <div class="col-md-8">
                  ...
                  <div class="card-head style-primary">
                    ...
                    <table class="table table-condensed no-margin">
                        ...
                        <tr data-classIndex="<?php echo $class->class_id; ?>">
                          ...
                          <td class="text-right">
                            ...
                            <a role="button" href="<?php echo base_url('school/delete_class').'/'.$class->class_id;?>" class="btn btn-icon-toggle" data-toggle="tooltip" data-placement="top" data-original-title="Delete">
...
<div style="display: none;" class="modal fade" id="editClassModal" tabindex="-1" role="dialog" aria-labelledby="formModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-sm">
      ...
      <?php echo form_open('school/update_class',array('class' => 'form-horizontal','role'=>'form')); ?>
        <div class="modal-body">
          <input name="class_id" id="class_id" type="hidden">
					...
					<div class="form-group">
						<div class="col-sm-4">
							<label for="room_no" class="control-label">Room No.
              </label>
						</div>
						<div class="col-sm-8">
